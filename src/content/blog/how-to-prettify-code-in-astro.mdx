...
import uglyCodeMobile from "../../../public/blog/how-to-prettify-code-in-astro/ugly-ass-code.jpeg";
import uglyCodeDesktop from "../../../public/blog/how-to-prettify-code-in-astro/ugly-ass-code.jpeg";
import beautifulCodeMobile from "../../../public/blog/how-to-prettify-code-in-astro/most-beautiful-thing-i-have-ever-seen.png";
import beautifulCodeDesktop from "../../../public/blog/how-to-prettify-code-in-astro/most-beautiful-thing-i-have-ever-seen.png";

Have you ever looked at a block of code and wanted to gouge your freaking eyes out?

<ImagePost
  mobileImgUrl={uglyCodeMobile}
  desktopImgUrl={uglyCodeDesktop}
  alt="Ugly ass code"
  figcaption="This is some random dude's comment on dev.to, hope he doesn't mind..."
/>
...
<ImagePost
  mobileImgUrl={beautifulCodeMobile}
  desktopImgUrl={beautifulCodeDesktop}
  alt="Beautiful snippet of code"
/>
